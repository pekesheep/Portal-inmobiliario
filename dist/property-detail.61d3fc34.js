...
exports.getPropertyDetail = exports.getEquipmentsList = exports.contactInformation = void 0;
...
var contactInformation = function contactInformation(contact) {
  return _axios.default.post("".concat(urlContact), contact).then(function (response) {
    return response.data;
  });
};
...
var mapPropertyDetailFromApiToViewModel = function mapPropertyDetailFromApiToViewModel(property, equipmentsList) {
  return {
    id: property.id,
...
var formatEquipment = function formatEquipment(property, equipmentsList) {
  var equipmentForViewModel = '';
  property.equipmentIds.map(function (equipmentId) {
    equipmentsList.find(function (equipment) {
      if (equipmentId === equipment.id) equipmentForViewModel = [].concat(_toConsumableArray(equipmentForViewModel), [equipment.name]);
    });
  });
...
Promise.all([(0, _propertyDetail.getPropertyDetail)(params.id), (0, _propertyDetail.getEquipmentsList)()]).then(function (_ref) {
  ...
  var viewModelPropertyDetail = (0, _propertyDetail2.mapPropertyDetailFromApiToViewModel)(property, equipments);
  (0, _propertyDetail3.setPropertyValues)(viewModelPropertyDetail);
});
var contact = {
  email: '',
  message: ''
