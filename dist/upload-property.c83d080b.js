...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/upload-property/upload-property.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapPropertyDetailFromFormToApi = void 0;

var mapPropertyDetailFromFormToApi = function mapPropertyDetailFromFormToApi(uploadProperty) {
  return {
...
exports.mapPropertyDetailFromFormToApi = mapPropertyDetailFromFormToApi;
...
exports.getSaleTypeList = exports.getProvinceList = exports.getEquipmentsList = exports.addProperty = void 0;
...
var getEquipmentsList = function getEquipmentsList() {
  return _axios.default.get("".concat(EquipmentsListurl)).then(function (response) {
    return response.data;
  });
};
...
var addProperty = function addProperty(uploadProperty) {
  return _axios.default.post("".concat(propertyUrl), uploadProperty).then(function (response) {
    return response.data;
  });
};
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-positive-number-validator":"../node_modules/@lemoncode/fonk-positive-number-validator/dist/@lemoncode/fonk-positive-number-validator.esm.js","@lemoncode/fonk-is-url-validator":"../node_modules/@lemoncode/fonk-is-url-validator/dist/@lemoncode/fonk-is-url-validator.esm.js"}],"pages/upload-property/upload-property.js":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _uploadProperty2.getSaleTypeList)(), (0, _uploadProperty2.getEquipmentsList)(), (0, _uploadProperty2.getProvinceList)()]).then(function (_ref) {
...
(0, _helpers.onUpdateField)('title', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('title', uploadProperty.title).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('title', uploadProperty.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('email', uploadProperty.email).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('phone', uploadProperty.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('price', uploadProperty.price).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('address', uploadProperty.address).then(function (result) {
...
(0, _helpers.onUpdateField)('city', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('city', uploadProperty.city).then(function (result) {
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('province', uploadProperty.province).then(function (result) {
...
(0, _helpers.onUpdateField)('squareMeter', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('squareMeter', uploadProperty.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)('rooms', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('rooms', uploadProperty.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)('bathrooms', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('bathrooms', uploadProperty.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('locationUrl', uploadProperty.locationUrl).then(function (result) {
    (0, _helpers.onSetError)('locationUrl', result);
  });
});

var setEvents = function setEvents(saleTypeList, equipmentsList) {
  saleTypeList.forEach(function (element) {
    var id = (0, _uploadProperty3.formatCheckboxId)(element);
    (0, _helpers.onUpdateField)(id, function (event) {
      var value = event.target.value;

      if (event.target.checked) {
        uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
          saleTypes: [].concat(_toConsumableArray(uploadProperty.saleTypes), [value])
        });
      }

      if (!event.target.checked) {
        uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
          saleTypes: _toConsumableArray(uploadProperty.saleTypes.filter(function (f) {
            return f !== value;
          }))
        });
      }

      _uploadProperty4.formValidation.validateField('saleTypes', uploadProperty.saleTypes).then(function (result) {
        (0, _helpers.onSetError)('saleTypes', result);
      });
    });
  });
  equipmentsList.forEach(function (element) {
    var id = (0, _uploadProperty3.formatCheckboxId)(element);
    (0, _helpers.onUpdateField)(id, function (event) {
      var value = event.target.value;
      ...
      if (event.target.checked) {
        uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
          equipment: [].concat(_toConsumableArray(uploadProperty.equipment), [value])
        });
      }

      if (!event.target.checked) {
        uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
          equipment: _toConsumableArray(uploadProperty.equipment.filter(function (f) {
            return f !== value;
          }))
        });
      }
...
(0, _helpers.onSubmitForm)('insert-feature-button', function () {
  var inputValue = document.getElementById('newFeature').value;

  if (inputValue || inputValue !== null) {
    (0, _uploadProperty3.onAddFeature)(inputValue);
    uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
      newFeature: [].concat(_toConsumableArray(uploadProperty.newFeature), [inputValue])
    });

    _uploadProperty4.formValidation.validateField('newFeature', uploadProperty.newFeature).then(function (result) {
      (0, _helpers.onSetError)('newFeature', result);
    });
  }

  (0, _helpers.onSubmitForm)((0, _uploadProperty3.formatDeleteFeatureButtonId)(inputValue), function () {
    (0, _uploadProperty3.onRemoveFeature)(inputValue);
    uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
      newFeature: _toConsumableArray(uploadProperty.newFeature.filter(function (f) {
        return f !== inputValue;
      }))
    });
  });
...
(0, _helpers.onAddFile)('add-image', function (event) {
  if (event || event !== null) {
    (0, _uploadProperty3.onAddImage)(event);
    uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
      images: [].concat(_toConsumableArray(uploadProperty.images), [event])
    });
  }
});
(0, _helpers.onSubmitForm)('save-button', function () {
  _uploadProperty4.formValidation.validateForm(uploadProperty).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);

    if (result.succeeded) {
      var uploadPropertyMapped = (0, _uploadProperty.mapPropertyDetailFromFormToApi)(uploadProperty);
      (0, _uploadProperty2.addProperty)(uploadPropertyMapped).then(function (response) {
        _router.history.back();
      });
    }
  });
});
},{"../../core/router":"core/router/index.js","./upload-property.mappers":"pages/upload-property/upload-property.mappers.js","./upload-property.api":"pages/upload-property/upload-property.api.js","../../common/helpers":"common/helpers/index.js","./upload-property.helpers":"pages/upload-property/upload-property.helpers.js","./upload-property.validations":"pages/upload-property/upload-property.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
